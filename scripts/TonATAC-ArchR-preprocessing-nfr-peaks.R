...
n_threads <- 15
genome <- "hg38"
data_dir <- "/lustre/scratch/kiviaho/spatac/data/tonsilatlas/scATAC-seq/"  # Remember to create an ArchR folder inside
inputFiles <- c("/lustre/scratch/kiviaho/spatac/data/tonsilatlas/scATAC-seq/BCLLATLAS_26/jmjpvq6z_fr6c4nyp/fragments.tsv.gz")
names(inputFiles) <- c("tonsil_atac")
proj_name <- "tonsil_atac"

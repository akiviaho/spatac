...
n_threads <- 15
genome <- ""
data_dir <- "/lustre/scratch/kiviaho/spatac/data/multiome10x/mouse-brain"
inputFiles <- c("/lustre/scratch/kiviaho/spatac/data/multiome10x/mouse-brain/e18_mouse_brain_fresh_5k_atac_fragments.tsv.gz")
names(inputFiles) <- c("multiome_5k")
proj_name <- "multiome10x_mouse"
